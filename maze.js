...
let players = [];
const img = new Image();
img.src = 'img/maze/piggy.jpg'; 
players.push(img);
const img3 = new Image();
img3.src = 'img/maze/goat.jpg'; 
players.push(img3);
const img4 = new Image();
img4.src = 'img/maze/cat.jpg'; 
players.push(img4);
const img5 = new Image();
img5.src = 'img/maze/monkey.jpg'; 
players.push(img5);
let index = 0;
...
function drawPlayer(x, y) {
    ...
    let newTopLeftX = (x + 0.5) * cellWidth - 0.4 * playerWidth;
    let newTopLeftY = (y + 0.5) * cellHeight - 0.5 * playerHeight;

    mazeContext.drawImage(players[index], newTopLeftX, newTopLeftY,playerWidth*0.8, playerHeight*0.9);
}
...
function drawStartMessage() {
    ...
    drawRect(0.5 * menuCanvas.width - 400, 0.5 * menuCanvas.height - 50,
                800, 100,
                menuContext,
                NAVY_LIGHT, NAVY_DARK);
...
function drawCounterTallies() {
    ...
    menuContext.fillText(solutionCounter + " / " + solutionTotal,
                         ...
                         BOX_OFFSET_Y*1.1 + 0.5 * BOX_HEIGHT);
    ...
    menuContext.fillText(randomCounter + " / " + randomTotal,
                         menuCanvas.width - BOX_OFFSET_X + 0.5 * BOX_WIDTH,
                         2 * BOX_OFFSET_Y*1.1 + 1.5 * BOX_HEIGHT);
...
function drawTimer(time) {
    ...
    menuContext.fillText(minutesLeft + ":" + secondsLeft,
                         menuCanvas.width - BOX_OFFSET_X + 0.5 * BOX_WIDTH,
                         3 * BOX_OFFSET_Y*1.1 + 2.5 * BOX_HEIGHT);
